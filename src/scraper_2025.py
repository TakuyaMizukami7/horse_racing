                    ...
                    for day in days:
                        ...
                        for race in races:
                            ...
                            if results:
                                ...
                                if len(self.current_year_data) >= 500: # Increase buffer slightly or keep frequent? 50 races * 14 rows ~ 700 rows.
                                    # Logic was "every 50 races scraped".
                                    # Let's count current_year_data size or races count.
                                    # Let's stick to total_races_scraped global counter for status, but save based on local buffer.
                                    self.save_data(year)
